...
Edit the following variables in the [config.js](./Source/Tailwind.Traders.Web/ClientApp/src/config.js) file in [src](./Source/Tailwind.Traders.Web/ClientApp/src) folder of the [ClientApp](./Source/Tailwind.Traders.Web/ClientApp) directory.
